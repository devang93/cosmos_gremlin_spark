...
libraryDependencies += "org.apache.tinkerpop" % "spark-gremlin" % "3.3.1"
libraryDependencies += "org.apache.tinkerpop" % "gremlin-core" % "3.3.1"
libraryDependencies += "org.apache.tinkerpop" % "gremlin-shaded" % "3.3.1"
libraryDependencies += "org.apache.tinkerpop" % "hadoop-gremlin" % "3.3.1"
